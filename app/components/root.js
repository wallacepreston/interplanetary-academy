  ...
  render () {
    ...
    <div>
      <nav>
        ...
        Interplanetary Academy of JavaScript | <Link to="/">Home</Link> | Welcome! What would you like to view? <Link to="/students">Students</Link> | <Link to="/campuses">Campuses</Link>
        </div>
      </nav>
